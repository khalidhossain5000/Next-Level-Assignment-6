...
18. `PATCH /api/v1/feeder/:feederId` - Update a distribution feeder. **Admin only**
19. `GET /api/v1/feeder` - Get all feeders. **Public**
20. `GET /api/v1/feeder/:feederId` - Get details of a specific feeder. **Public**
